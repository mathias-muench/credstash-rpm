...
Requires:      python2-cryptography >= 1.5, python2-cryptography < 2.1, python-boto3 >= 1.1.1
...
Requires:      python%{python3_pkgversion}-cryptography >= 1.5, python%{python3_pkgversion}-cryptography < 2.1, python%{python3_pkgversion}-boto3 >= 1.1.1
Requires(post): %{_sbindir}/update-alternatives
Requires(postun): %{_sbindir}/update-alternatives
